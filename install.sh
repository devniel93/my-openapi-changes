...
get_asset_name() {
  echo "openapi-changes_$1_$2_$3.tar.gz"
}

get_download_url() {
  local asset_name=$(get_asset_name $1 $2 $3)
  echo "https://github.com/devniel93/my-openapi-changes/releases/download/v$1/${asset_name}"
}

get_checksum_url() {
  echo "https://github.com/devniel93/my-openapi-changes/releases/download/v$1/checksums.txt"
}
...
do_install_binary() {
  ...
  echo "Installed openapi-changes to $INSTALL_DIR"
...
install_termux() {
  echo "Installing openapi-changes, this may take a few minutes..."
...
openapi-changes is now installed! type 'openapi-changes' to see a list of commands
